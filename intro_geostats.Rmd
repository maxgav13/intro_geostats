...
Es buena práctica determinar las distancias entre los puntos, ya que como se explicó en la parte teórica, no es recomendado calcular el variograma experimental a más de la mitad de la distancia máxima entre puntos. Haciendo este paso se obtiene que la distancia máxima es de `r apa(distancias[3],2)` m.
...
```{r xval, eval=TRUE, message=FALSE, echo=FALSE}
...
```{r kriging, eval=TRUE, echo=FALSE, message=FALSE}
ok = krige(myformula, 
           locations = datos_sp,
           newdata = datosint2, 
           model = varmod)
